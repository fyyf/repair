  ...
  <body>
    ...
    <br>
      <form class="form-info" >
        <h2 class="form-heading" id="user_name"><?php echo ($user["name"]); ?></h2>
        <h3><?php echo ($user["phone"]); ?> <a href="/repair/index.php/Home/Index/set">修改</a></h3>
        <p><select class="form-control" name="user_computer" id="user_computer">
            <?php if(is_array($computer_list)): foreach($computer_list as $key=>$vo): ?><option value="<?php echo ($vo["computer_id"]); ?>"><?php echo ($vo["brand"]); echo ($vo["model"]); ?>-<?php echo (date("Y年m月",$vo["buy_time"])); ?>购买</option><?php endforeach; endif; ?> 
        ...
        <div class="modal fade" id="deal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
            <h4>报修流程：</h4>
            <img src="/repair/Public/pic/liuchengtu1.png" width="270px;" height="52px;"><img src="/repair/Public/pic/liuchengtu.png" width="70px;" height="52px;">
...
//按下回车
  $("body").keydown(function() {
      ...
      if($("#description").val()==""){$("#error_description").show();}
        ...
        $.post("/repair/index.php/Home/Index/handle", {description:description,computer_id:computer_id},
          function(data){
            if(data.status==0){
              alert(data.in);
                    $("#repair").text('一键报修')
                  ...
                  window.location.href="/repair/index.php/Home/Index/order";//报修成功跳转
                }
        });
      }
        }
